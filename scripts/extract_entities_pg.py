...
BLACKLIST_EXACT = {
    ...
    # ── Common nouns falsely detected as persons ──
    "гимнастка", "спортсмен", "спортсменка", "тренер",
    "футболист", "боксёр", "борец", "журналист", "журналистка",
    "режиссёр", "актёр", "актриса", "певец", "певица",
    "учёный", "врач", "доктор", "профессор", "академик",
    "блогер", "бизнесмен", "предприниматель",
    "потерпевший", "потерпевшая", "подозреваемый", "подозреваемая",
    "обвиняемый", "обвиняемая", "пострадавший", "пострадавшая",
    "истец", "ответчик", "свидетель",

    # ── Common false positive single words ──
    "гражданин", "гражданка", "житель", "жительница",
    "студент", "студентка", "пенсионер", "пенсионерка",
    "мужчина", "женщина", "ребёнок", "подросток",
}
